...
def detect_injection(user_input: str) -> bool:
    ...
    INJECTION_PATTERNS = [
        ...
        r"pretend to be",
        r"act as (a|an|the) (unrestricted|jailbroken)",
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response(
                "I cannot process this request. It appears to violate safety guidelines (Injection detected)."
            )

        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response(
                "I can only assist with banking-related questions. Please ask something about our services."
            )
